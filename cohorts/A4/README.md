...
Models the Preclinical Alzheimer's Cognitive Composite (PACC) as a continuous outcome —
a FLAML/LightGBM regression pipeline plus time-varying and cubic-spline R models. See
[`pacc/README.md`](pacc/README.md).
