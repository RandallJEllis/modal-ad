...
def process_aibl(
    ...
    '''
    We use adni_demo_file_path for the demographic information because the AIBL data does not have complete demographic information.
    '''
...
def make_cv_folds(output_path, ad_outcome=False):
    ...
    # AIBL and ADNI have overlapping subjects. Keep only AIBL subjects with RID NOT contained in ADNI
    # Only filter and retain subjects in AIBL that are not in ADNI
